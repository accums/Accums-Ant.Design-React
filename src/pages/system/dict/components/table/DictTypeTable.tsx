...
const DictTypeTable: React.FC<any> = (props) => {
  ...
  return (
    <ProTable
      ...
      toolbar={{
        actions: [
          <AddDictTypeModalForm key={"AddDictTypeModalForm"} actionRef={actionRef}/>,
          <EditDictType key={"EditDictType"} actionRef={actionRef} dictTypeId={dictTypeId}/>,
          <DeleteDictTypeAndDictPopConfirm key={"DeleteDictTypeAndDictPopConfirm"} actionRef={actionRef}
