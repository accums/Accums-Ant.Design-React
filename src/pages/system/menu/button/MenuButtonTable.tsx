...
export default (param: { record: any }) => {
    ...
    return (
        <ModalForm trigger={<a>按钮设置</a>} submitter={false}>
            <ProTable<any>
                ...
                toolBarRender={() => {
                    return [
                        <AddMenuButtonForm menuId={param.record.menuId} actionRef={actionRef}/>,
                        <EditMenuButtonForm buttonId={buttonId} menuId={param.record.menuId} actionRef={actionRef}/>,
                        <DeleteMenuButtonPopConfirm buttonId={buttonId} actionRef={actionRef}/>,
                    ]
                }}
            />
        </ModalForm>
